"""
Run inference with the best Task 2 checkpoint on test.parquet.
Saves raw pCTR scores to outputs/submissions/scores_v1.npy.
"""
...
OUT_PATH = config.OUTPUTS_DIR / "submissions" / "scores_v1.npy"
